...
git clone https://github.com/hyperpolymath/volumod.git cd volumod
...
toolbox create volumod-dev toolbox enter volumod-dev # Install
...
volumod/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
